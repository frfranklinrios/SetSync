...
from product_updates import CAMPAIGN_NOTIFICACOES_2026_06, enviar_comunicado
...
def main() -> int:
    ...
    parser.add_argument(
        '--campaign',
        default=CAMPAIGN_NOTIFICACOES_2026_06,
        help='ID da campanha (padrão: notificações jun/2026)',
    )
